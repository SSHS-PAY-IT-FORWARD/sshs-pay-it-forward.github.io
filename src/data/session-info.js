export default [
  ...
  },
  {
    ...
    description:
      "인구 감소 문제가 날로 심각해져감에 따라, 부족한 노동인력을 로봇으로 대체해야만 한다는 생각이 증가하고 있다. 때마침 로봇 HW의 비약적 발전과  나날이 똑똑해져가는 AI 기술은, 빅테크를 중심으로 Physical AI에 대한 대규모 투자가 진행중이다. 휴머노이드의 세상이 온 것일까? 우리는 무엇을 더 연구하고, 무엇에 대비해야 하는가?",
...
//
  ...
  },
  {
    ...
    description:
      "기존 기술로는 달성하기 어려운 새로운 기능과 성능을 제공하는 양자 역학 기반의 기술들이 주목받고 있다. 양자 컴퓨팅, 양자 통신, 양자 센서, 양자 암호 등 다양한 기술과, 정보 처리, 통신, 센싱 등 여러 분야에서 혁신을 가져올 것이라 불리는 이 기술의 실체는 무엇인가?",
